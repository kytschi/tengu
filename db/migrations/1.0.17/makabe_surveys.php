...
/**
 * Class MakabeSurveysMigration_117
 */
class MakabeSurveysMigration_117 extends Migration
{
    /**
    ...
    {
        $this->morphTable('makabe_surveys', [
            'columns' => [
                new Column(
                    'id',
                    [
            ...
            'indexes' => [
                ...
                new Index('makabe_surveys_complete_page_id_IDX', ['complete_page_id'], ''),
